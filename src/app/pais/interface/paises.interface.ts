...
//
//   const rESTCountryResponde = Convert.toRESTCountryResponde(json);
//
...
export class Convert {
    public static toRESTCountryResponde(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RESTCountryResponde")));
    }

    public static rESTCountryRespondeToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RESTCountryResponde"))), null, 2);
    }
}
